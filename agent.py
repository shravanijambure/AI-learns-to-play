...
class Agent:
    def __init__(self):
        ...
        self.memory=deque(maxlen=MAX_MEMORY)#pops elements if the deque is full from the left
    ...
    def get_action(self, state):
        ...
        if random.randint(0,200)<self.epsilon:
            ...
            move=torch.argmax(prediction).item()#tensor to number
            final_move[move]=1
        return final_move 
